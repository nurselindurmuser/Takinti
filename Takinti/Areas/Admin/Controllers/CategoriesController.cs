...
namespace Takinti.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Slug,Icon,Photo,ShowInHome,ParentCategoryId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Slug,Icon,Photo,ShowInHome,ParentCategoryId")] Category category)
        {
            if (ModelState.IsValid)
            {
